        ...
        <div>
            <section className="login min-h-screen  flex items-center justify-center px-5">
                <div className='xl:w-4/12 lg:w-5/12 md:8/12 sm:w-[450px] tablet:w-2/3  w-full bg-white rounded-3xl px-6 md:px-20 py-8 md:py-24'>
                    <h1 className='text-center text-3xl text-primary font-medium'>Reset Password</h1>
                    <div className="form">
                        <form onSubmit={handleForgotPassword} className="py-8">
                            ...
                            <div className="form-group my-3">
                                <input type="password" className='bg-white border-b border-gray-300 px-4 py-3 text-dark w-full' placeholder='Password Confirmation' onChange={(e) => { setPasswordConfirmation(e.target.value) }} />
                            </div>
