...
export default function EditBlog() {
    ...
    // const { title, description, content, image, coverimage} = blog
    ...
    const UpdateBlog = (e) => {
        ...
        console.log(data)
        axios.put('/blogs/' + id, data, config)
            .then(res => {
                setLoading(false)
                console.log(res)
    ...
    return (
        <div className='add-blog'>
            <div className="breadcumb p-4">
                <AdminBreadcrumb title="Edit Blog" />
            </div>
            <div className="page-content">
                <div className="heading p-5 bg-white flex justify-between items-center">
                    <h2 className="text-slate-800 font-semibold text-2xl">Edit Blog</h2>
                ...
                <form onSubmit={UpdateBlog} encType="multipart/form-data">
                    <div className="main-page-content flex flex-wrap p-5">
                        <div className="w-8/12 bg-white p-4 rounded md:opacity-100 admin-blog">
                            <div className="form md:p-5">
                                ...
                                <div className="form-group my-3 mb-5 w-full">
                                    ...
                                    {/* <textarea type="text" id="content" className="bg-slate-50 border-gray-200 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-60 dark:text-white my-2" placeholder="Content" name="content" rows="20" value={content} onChange={(e) => { setContent(e.target.value) }}></textarea> */}
                                    <Editor
                                        apiKey={api}
                                    ...
                                    />
                                    {/* <p className="text-red-500 my-2 text-sm" v-if="errors.description">{{ errors.description.message }}</p> */}
                                </div>

                            </div>
                        </div>
                        <div className="w-4/12 bg-white p-4 rounded md:opacity-100 admin-blog">
                            <div className="md:p-5">
                                <div className="form-group mb-5 my-3">
                                    ...
                                    <p className='my-2 mb-4 text-gray-600 text-xs'><span className='font-bold'>Note:</span> Please upload image of resolution 800x500</p>
                                    ...
                                    {/* preview image */}
                                    {previewimage ? <><img src={previewimage} alt="featuredimage" className="my-5 max-w-1 max-w-xs w-full mx-auto" /></> : <><img src={image} alt="featuredimage" className="my-5 max-w-1 max-w-xs w-full mx-auto" /></>}
                                </div>
                                <div className="form-group mb-5 my-3">
                                    <label className="block uppercase font-semibold text-xs text-slate-900 mb-2">Cover Image</label>
                                    <p className='my-2 mb-4 text-gray-600 text-xs'><span className='font-bold'>Note:</span> Please upload image of resolution 1920x700</p>
                                    <div className="my-3 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                        <div className="space-y-1 text-center">
                                            <svg className="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                                                <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    ...
                                    {/* preview cover image */}
                                    {previewcoverimage ? <><img src={previewcoverimage} alt="coverimage" className="my-5 max-w-1 max-w-xs w-full mx-auto" /></> : <><img src={coverimage} alt="coverimage" className="my-5 max-w-1 max-w-xs w-full mx-auto" /></>}
                                </div>
                            </div>
                        </div>
                    </div>
                    {/* submit cancel button */}
                    <div className="form-group my-4 md:px-12 px-6">
